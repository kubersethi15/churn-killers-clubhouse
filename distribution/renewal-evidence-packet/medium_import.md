# Medium import checklist: Your Renewal Forecast Needs Receipts
...
2. Import https://churnisdead.com/newsletter/renewal-evidence-packet
3. Confirm the canonical URL is https://churnisdead.com/newsletter/renewal-evidence-packet
4. Check headings, source links, and the playbook link after import
5. Add this disclosure before publication:

   Editorial note: This article was researched and developed with AI assistance, then reviewed, sourced, and approved under Kuber Sethi's standing publication mandate.
