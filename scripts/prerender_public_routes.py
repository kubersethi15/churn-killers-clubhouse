...
ROUTES = {
    ...
    "start": (
        ...
        "A clear starting point for Customer Success people who want practical help instead of vague advice.",
        "New here? Start here.",
    ...
    "subscribe": (
        ...
        "Get one honest Customer Success take and one practical tool every Tuesday. Free, direct, and written for people doing the work.",
    ...
    "topics": (
        ...
        "Find practical guidance on renewals, measurement, health scores, AI, and the messy work between CS and the rest of the company.",
    ...
    "topics/measurement-decisions": (
        "Customer Success Measurement That Helps | Churn Is Dead",
        "Replace reassuring Customer Success dashboards with measures that help the team notice a real change and respond usefully.",
        "Numbers that help you act",
        "Know what action a number should inform before you track it.",
    ),
    "topics/ai-role-design": (
        "AI and the CS Work That Still Needs People | Churn Is Dead",
        "Use AI for repetitive work while protecting the judgment, trust, and difficult conversations customers still need from people.",
        "AI and the work that still needs people",
        "Choose what AI should help with and where a person still needs to take responsibility.",
    ),
    "topics/operating-systems": (
        "Making Customer Success Work Across Teams | Churn Is Dead",
        "Practical ways to stop customer problems getting lost between CS, Product, Sales, Support, and leadership.",
        "Making CS work across teams",
        "Use simple routines to stop customer problems falling between teams.",
    ),
    ...
    "about": (
        ...
        "Why Churn Is Dead exists, who it serves, and the publishing rules behind each weekly Customer Success issue.",
        "About Churn Is Dead",
        "Honest Customer Success thinking for people doing the work, written by Kuber Sethi.",
    ),
    "editorial-standards": (
