...
|---|---|---|---|---|
| CG-05 community-native contribution | Codex | `growth/cg05-community-native`; public practitioner communities; LinkedIn fallback | Thirty-discussion signal map complete; Reddit answer parked after sign-in failed; one no-link LinkedIn fallback comment published and verified on Seán Reid's 2027 CS-trends discussion | Claimed: `growth/cg-05-community-signal-map.md` and consequential external-action log. No community link drop before the CID-001 baseline closes. |
...
| CG-09 costly-problem ledger and analytics guard | Claude | merged PR [#90](https://github.com/kubersethi15/churn-killers-clubhouse/pull/90); corrective PR [#97](https://github.com/kubersethi15/churn-killers-clubhouse/pull/97) | Host guard deployed and verified at 05:29:38 UTC; BC-01 changes requested | Use the conservative 05:30 UTC cutoff in `growth/production-growth-cutover-2026-08-24.md`. Preserve session deduplication, one on-site source class, resource mapping, and narrowed evidence language. Add the corrective cutoff upsert, both Gate 0 conditions, and the host regression contract before merge. |
...
|---|---|---|---|
| 1 | CG-01 | Weekday LinkedIn relationship loop | Social manager: five to seven verified no-link comments per weekday. Agent research lane: up to three additional high-value comments on separately claimed threads, with shared duplicate checks and aggregate weekly evidence |
