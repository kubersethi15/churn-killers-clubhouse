...
| CID-002 LinkedIn link-placement crossover | Codex + social manager | `growth/linkedin-inline-link-test`; 8 September Tuesday post | First direct-in-body observation staged for 8 September after CID-001 closes | The 25 August post produced 870 impressions but seven tagged site visits, while its first-comment link had 171 impressions. The 8 September senior-CSM post keeps the text-only format, 18:15 timing, site CTA and free-playbook promise but carries the exact canonical URL in the body with `tuesday_inline_link`. Alternate placement across later comparable Tuesday issues and require at least two posts plus 20 tagged visits per placement before a decision; topic differences prevent a one-post causal claim. |
