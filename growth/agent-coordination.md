...
|---|---|---|---|---|
| SITE-04 QBR template continuity repair | Codex | `fix/qbr-three-slide-template` | Active 3 September 2026 | Replace the incorrect six-page QBR guide and generic four-question workspace with the confirmed thirty-minute, three-slide template. Claimed: `public/pdfs/30-Minute-QBR-Framework-ChurnIsDead.pdf`, `scripts/generate_qbr_template.py`, `src/pages/Playbook.tsx`, `src/pages/PlaybookWorkspace.tsx`, and the QBR manifest row only. Preserve the live LinkedIn tracked vault URL and all unrelated playbooks. |
