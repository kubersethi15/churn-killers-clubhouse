...
| LOOP-03 welcome activation measurement | Codex | `codex/loop-03-welcome-activation-audit` | Claimed 24 August; implementation and evidence audit in progress | `supabase/migrations/*welcome_activation*`, `src/pages/GrowthDashboard.tsx`, generated Supabase types, LOOP-03 decision record, tests, and the matching aggregate action-log entry. Do not change welcome copy during CID-001. |
