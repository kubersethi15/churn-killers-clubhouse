...
| Claude acquisition sprint activation | Codex | PR [#77](https://github.com/kubersethi15/churn-killers-clubhouse/pull/77), expansion PR [#91](https://github.com/kubersethi15/churn-killers-clubhouse/pull/91), and execution issue [#92](https://github.com/kubersethi15/churn-killers-clubhouse/issues/92) | Active; 20 immediate audience-system tasks and five gated follow-throughs span engagement, collaboration, live formats, practitioner evidence, syndication, original research, referrals, appearances, and co-creation | Claude owns CG-01 and CG-08 research, then CG-15/CG-18 as the next priority lanes. Completing one document is not a stopping condition. |
...
| CG-09 costly-problem ledger and analytics guard | Claude | PR [#90](https://github.com/kubersethi15/churn-killers-clubhouse/pull/90) | Changes requested | Preserve the production-host guard; correct unique-session counting, genuinely independent source classes, `resource_id` mapping, tests, and contamination wording before merge. Manifest files remain unchanged. |
