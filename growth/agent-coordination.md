...
| SITE-03 category-defining editorial art direction | Codex | `codex/category-defining-editorial-design` | Active 24 August 2026 after Kuber approved a cohesive visual transformation | Claimed: `src/pages/Index.tsx`, public publication layout surfaces, `Header`, `Footer`, `BrandMark`, shared editorial CSS/tokens, and presentation-only article/playbook styling. Preserve approved copy, routes, analytics, forms, CID-001 launch details, and CS Analyzer product behavior. |
