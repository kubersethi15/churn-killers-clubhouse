INSERT INTO public.newsletters (title, slug, content, excerpt, read_time, category, published_date) VALUES (
...
*P.S. — I know this one stings. If you disagree, I want to hear it. Hit reply and tell me why I''m wrong. The best responses will get featured in next week''s issue. And if you''re nodding along feeling uncomfortable, that''s probably a sign the Survival Audit is worth running.*',
  'Most CS teams don''t deserve to survive. The layoffs aren''t an injustice — they''re a market correction. Here''s the 5-point Survival Framework that separates the uncuttable from the unemployed.',
  '6 minutes',
  'Strategy',
  '2026-02-25T07:00:00+00:00'
);;
