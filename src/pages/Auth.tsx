...
const Auth = () => {
  ...
  const { signIn, signUp, signInWithGoogle, signInWithMagicLink, resetPassword, user, isLoading: authLoading } = useAuth();
  ...
  const handleGoogleSignIn = async () => {
    ...
    // Don't set isLoading to false on success - redirect will happen
  };
